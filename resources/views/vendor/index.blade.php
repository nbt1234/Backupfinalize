...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('public/template/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}"template/>
  <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed dark-mode">
        ...
        <li class="nav-item dropdown user-menu">
          ...
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
           ...
           <li class="user-footer">
            <a href="{{url('vendor/edit-profile')}}"
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item">
            ...
            @if ($last=='dashboard') active @endif">
          ...
          <li class="nav-item">
            ...
            @if ($last=='products' || $last=='product-page' || $second=='category-edit') active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Products
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('vendor/inventory')}}" class="nav-link 
            @if ($last=='inventory') active @endif">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Inventory
              </p>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="http://adminlte.io">finalize</a>.</strong>
    All rights reserved.
  </footer>
...
<!-- jQuery -->
<script type="text/javascript"> var base_url = "<?php echo url('') . '/'; ?>"
...
<script src="{{ asset('public/vendor-assets/js/vendorjs.js') }}"></script>
