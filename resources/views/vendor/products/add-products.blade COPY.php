...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form id="add-product" role="form" method="post" action="{{ url('vendor/add-product-ven') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="pro_name" class="form-control"
                                                            id="pro_name" placeholder="Enter product name"
                                                            value="pro name{{ old('pro_name') }}">
                                                        @error('pro_name')
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="textarea" name="short_decription"
                                                            placeholder="short_decription">shrt desc{{ old('short_decription') }}</textarea>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="textarea" name="description"
                                                            placeholder="description">deas dsa dasd as ddsa da sdf sd fs dfs f  sdfssc{{ old('description') }}</textarea>
                                                        @error('description')
                                                            <div class="form-valid-error">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6 category-section">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select2-primary">
                                                            <select class="select2 product-categories" id="cat_ids"
                                                                name="cat_ids" data-placeholder="Select category"
                                                                style="width:100%;">
                                                ...
                                                <div class="col-md-6 subcategory-section">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select2-primary">
                                                            <select class="select2 subcategories" name="subcate[]"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Brands</label>
                                                        <div class="select2-primary">
                                                            <select class="select2" id="brands" name="brands"
                                                                data-placeholder="Select brands" style="width:100%;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Tags</label>
                                                        <div class="select2-primary">
                                                            <select class="select2" id="tag" name="tag[]"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" id="product_type"
                                                            name="product_type">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" name="status"
                                                            checked id="active_status" value="0">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="price" class="form-control" id="price"
                                                            placeholder="Enter price" value="100{{ old('price') }}">
                                                        @error('price')
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" class="form-control" id="title"
                                                            placeholder="Enter title" value="meta{{ old('title') }}">
                                                        @error('title')
                                                            <div class="form-valid-error">{{ $message }}
                                                            </div>
                                                        @enderror
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="meta_descr" class="form-control"
                                                            id="meta_descr" placeholder="Enter meta description"
                                                            value=" meta desc{{ old('meta_descr') }}">
                                                        @error('meta_descr')
                                                            <div class="form-valid-error">{{ $message }}
                                                            </div>
                                                        @enderror
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" name="base_img" class="custom-file-input"
                                                        id="base_img">
                                        ...
                                        <div class="product-imgs-section">
                                            ...
                                            <div class="row product-img-block0">
                                                ...
                                                <div class="col-md-2">
                                                    <button type="button"
                                                        class="btn add-product-ven-img btn-block btn-warning"><i
    ...
    <div class="hidden" id="attr_option">
        ...
        @foreach ($attr_info as $key => $attr)
            <option value={{ $attr->attr_name }}>{{ $attr->attr_name }}</option>
        @endforeach
    </div>
@stop
