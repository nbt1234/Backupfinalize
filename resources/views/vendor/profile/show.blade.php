                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="@if($vendor_info->avatar=='')
                                https://miro.medium.com/max/600/1*PiHoomzwh9Plr9_GA26JcA.png
                            @elseif($vendor_info->login_type=='email')
                                {{asset('public/vendor-assets/img/avatar/'.$vendor_info->avatar)}}
                            @else
                                {{$vendor_info->avatar}}
                            @endif" alt="User profile picture">
                            </div>

                            <h3 class="profile-username text-center">{{ucfirst($vendor_info->username)}}</h3>

                            <p class="text-muted text-center">{{$vendor_info->email}}</p>

                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Sells</b> <a class="float-right">1,322</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Products</b> <a class="float-right">543</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Total Product</b> <a class="float-right">13,287</a>
                                </li>
                            </ul>

                            <a target="_new" href="//finalize.com/vendor/{{$vendor_info->ven_slug}}"
                                class="btn btn-primary btn-block"><b>Show Vendor</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted">{{substr($vendor_info->bio,0,100)}}...</p>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="settings">
                                    <form class="form-horizontal" method="post"
                                        action="{{ url('vendor/update-profile') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="name" class="form-control" id="inputName"
                                                    value="{{$vendor_info->name}}" placeholder="Name">
                                                @error('name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" name="email" class="form-control" id="inputEmail"
                                                    value="{{$vendor_info->email}}" placeholder="Email">
                                                @error('email')
                                                <div class="form-valid-error">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="username" class="form-control"
                                                    id="inputUsername" value="{{$vendor_info->username}}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="mobile" class="form-control" id="inputmobile"
                                                    value="{{$vendor_info->mobile}}" placeholder="Mobile">
                                                @error('mobile')
                                                <div class="form-valid-error">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="profile-img" class="col-sm-2 col-form-label">Profile Picture</label>
                                            <div class="col-sm-10">
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="profile-img" name="avatar">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="inputBio" name="bio"
                                                    placeholder="Bio">{{$vendor_info->bio}}</textarea>
                                                @error('bio')
                                                <div class="form-valid-error">{{ $message }}</div>
                                                @enderror
                                            </div>
