            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">EDIT Content Creators</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Content Creators</h3>
                        </div>
                        <!-- form start -->
                        <form role="form" method="post" action="{{url('finalize-site-admin/creators-update/'.$result->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                            <div class="form-group">
                                    <label for="coupon_name">Name</label>
                                    <input type="text" class="form-control" name="name" id="name" 
                                    placeholder="Enter Name" value="{{$result->title}}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    placeholder="Enter Content" value="{{$result->sub_title}}">
                                    @error('content')
                                        <div class="form-valid-error">{{ $message }}</div>
                                    @enderror
                                </div>
