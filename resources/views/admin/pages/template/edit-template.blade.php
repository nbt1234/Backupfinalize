            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- form start -->
                        <form role="form" method="post" action="{{url('finalize-site-admin/template-update/'.$template_info->slug)}}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="template_name" class="form-control" id="template_name"
                                        placeholder="Enter template_name" value="{{$template_info->name}}">
                                    @error('template_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="heading" class="form-control" id="heading"
                                        placeholder="Enter heading" value="{{$template_info->heading}}">
                                    @error('heading')
                                    <div class="form-valid-error">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <img src="{{asset('public/admin-assets/img/pages/template/'.$template_info->img)}}" class="sm-img">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="textarea" id="content" placeholder="Enter content"
                                        value="">{{$template_info->content}}</textarea>
                                    @error('content')
                                    <div class="form-valid-error">{{ $message }}</div>
                                    @enderror
                                </div>
