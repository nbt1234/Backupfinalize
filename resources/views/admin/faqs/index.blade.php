            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                      <a href="{{url('finalize-site-admin/faq-page')}}"><button type="button" class="btn btn-primary">Add Faq</button></a>
                  </div>
                  <div class="card-body">
                    <table id="data-table" class="table table-hover table-bordered table-striped el-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{!! substr((strip_tags($single_info->heading)),0,50) !!}</td>
                                ...
                                <td>
                                    <a href="{{url('finalize-site-admin/faq-edit/'.$single_info->id)}}" target="_blank"><button type="button" class="btn btn-block bg-gradient-primary btn-xs">Edit</button></a>
                                    <a onclick="confirm_box_delete('{{$single_info->id}}','finalize-site-admin/faq-delete')"><button type="button" class="mt-2 btn btn-block bg-gradient-danger btn-xs">Delete</button></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
