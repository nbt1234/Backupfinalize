  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">Enter your key to recover the password.</p>

        <form action="{{url('finalize-admin-login/key-verify')}}" method="post">
          @csrf
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control" name="key" placeholder="Enter Key" value="{{old('key')}}">
          ...
          <div class="row">
            <div class="col-12">
              <button type="submit" class="btn btn-primary btn-block">Enter Key</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
